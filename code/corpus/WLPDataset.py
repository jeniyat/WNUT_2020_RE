...
class WLPDataset:
    ...
    def get_rel_fvectors(self, relations):
        print("Collecting all the relations ...")
    ...
    def __gen_all_ent_features(self, do_dep=False):
        ...
        for p in tqdm(self.protocols, desc="Collecting features", disable=True):
    ...
    def read_protocols(self, gen_features, skip_files, genia=None, dir_path=None, filenames=None):
        ...
        # print(filenames)
        print("loading protocols from : ", dir_path)
