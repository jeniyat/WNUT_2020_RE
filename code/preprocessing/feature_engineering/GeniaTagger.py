...
class GeniaTagger(object):
    ...
    def dl_and_make(self):
        ...
        r = requests.get("http://www.nactem.ac.uk/GENIA/tagger/geniatagger-3.0.2.tar.gz", stream=True)
        ...
        # tgz_path = os.path.join(self._dir_to_tagger, "geniatagger-3.0.2.tar.gz")
        # urllib.request.urlretrieve("http://www.nactem.ac.uk/tsujii/GENIA/tagger/geniatagger-3.0.2.tar.gz", tgz_path)
        # z = tarfile.open(tgz_path)
        # z.extractall(path=os.path.dirname(self._dir_to_tagger))
